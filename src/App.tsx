...
function Hub({ profile, sections, canOpenCollection, canOpenCalendar, canOpenSchedule, canInvite, canManageMembers, canCreateSections, onCollection, onCalendar, onSchedule, onSettings, onCreateSection }: { profile: Participant | null; sections: WorkspaceSection[]; canOpenCollection: boolean; canOpenCalendar: boolean; canOpenSchedule: boolean; canInvite: boolean; canManageMembers: boolean; canCreateSections: boolean; onCollection: () => void; onCalendar: () => void; onSchedule: () => void; onSettings: () => void; onCreateSection: (event: FormEvent<HTMLFormElement>) => Promise<boolean> }) {
